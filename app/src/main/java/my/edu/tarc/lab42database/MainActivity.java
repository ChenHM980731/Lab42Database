...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if(requestCode == INSERT_USER_REQUEST && resultCode == RESULT_OK){
            User user = new User();
            user.setFirstName(data.getStringExtra(AddActivity.INSERT_FIRST));
            user.setLastName(data.getStringExtra(AddActivity.INSERT_LAST));
            user.setPhone(data.getStringExtra(AddActivity.INSERT_PHONE));
